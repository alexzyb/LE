...
- **Page 1 运营监控**: 顶栏(Logo+DatePicker+语言+阈值) → KPI卡片行(6张) → 6个分区面板(Production/Mill/Dryer/Quality/CHP/Downtime) → 底部64列全数据表
- **Page 2 AI Placeholder**: 4 个伪数据占位面板 + 灰色 overlay + "Coming Soon"
...
| `docs/layout-spec.md` | 写页面布局时 | ASCII 线框图、KPI 卡片定义、Page 2 占位设计、完整验收标准 |
